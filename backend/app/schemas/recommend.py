...
class RecommendResponse(BaseModel):
    ...
    # True when Gemini ranked the deck; False on color-sorted retrieval fallback.
    curated_by_ai: bool = True
    # Alias kept for earlier clients / notes that used used_llm.
    used_llm: bool = True
